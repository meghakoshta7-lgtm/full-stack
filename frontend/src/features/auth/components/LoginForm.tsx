    ...
    <motion.div
      ...
      <div className="rounded-[20px] px-10 py-8"
        ...
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.div variants={item}>
            <button type="button"
              className="w-full py-[10px] px-4 rounded-[10px] font-semibold text-[13px] flex items-center justify-center space-x-2 transition-all"
              style={{ border: '1.5px solid #e2e8f0', background: '#ffffff', color: '#475569' }}>
